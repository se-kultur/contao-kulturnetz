...
$GLOBALS['TL_DCA']['tl_member']['fields']['street']['label'] = ['Straße und Hausnummer', ''];
...
$GLOBALS['TL_DCA']['tl_member']['list']['global_operations']['csv'] = array(
	'href'      => '#',
	'button_callback'=> array('tl_member_extended', 'downloadButton')
);
...
class tl_member_extended extends Backend {
	...
	public function downloadButton($arrRow, $href, $label, $title, $icon) {
        return '
		<a href="./files/se-kultur.de/code/csvMembers.php" style="display:inline-block;margin-left: 15px;">
